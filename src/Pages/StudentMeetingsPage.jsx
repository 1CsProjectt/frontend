...
function StudentMeetingPage() {
  ...
  const renderTabContent = () => {
    if (activeTab === "My meetings") {
            ...
            <div className={Module["Right-side"]}>
              <div className={Style["table-wrapper"]}>
                <table>
                  ...
                  <tbody>
                    {nextMeeting && !nextMeeting.work_Status ? (
                      <tr>
      ...
      return (
        <>
          <div className={Module["headerSoutnance"]}>This week meeting</div>
          <div className={Module["headerSoutnanceList"]}>
            <ul>
              <li>
                Welcome to the soutenance decision section where you can see if
                your teacher has confirmed you’re ready for the soutenance.
              </li>
              <li>
                Teams confirmed earlier will be given scheduling priority.
              </li>
              <li>
                The place, time, and jury assignments will be set after this
                session ends in a new panel, and you and your team will be
                notified.
              </li>
              <li>
                You need to upload your final deliverables before the soutenance
                starts and after confirmation from your supervisor.
              </li>
            </ul>
          </div>
          <div className={Module["Supervisor-decision"]}>
            <div className={Module["Lside"]}>Supervisor decision</div>
            <div
            ...
            >
              {status === "ready"
                ? "You are ready for the soutenance"
